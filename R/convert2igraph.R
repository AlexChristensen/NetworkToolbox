...
#' @description Converts single or multiple networks into \code{igraph}'s format for network analysis
#'
...
#'
#' @return Returns a network matrix in \code{igraph}'s format or
#' returns a list of brain connectivity matrices each of which have been
#' convert to \code{igraph}'s format
#'
#' @examples
